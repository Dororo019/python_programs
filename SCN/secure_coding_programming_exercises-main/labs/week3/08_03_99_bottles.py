...
while(True):
    print("there are 100 jars of payasam on the counter ...... now i ate one!"
"      " "there are 99 jars of payasam on the counter ... now I ate one!""     " "there are 0 jars of payasam on the counter - none left to eat!"
"now I will go vomit...."
)
    break